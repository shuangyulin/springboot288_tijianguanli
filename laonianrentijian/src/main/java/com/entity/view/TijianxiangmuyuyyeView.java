...
public class TijianxiangmuyuyyeView extends TijianxiangmuyuyyeEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 审核状态的值
		*/
		private String tijianxiangmuyuyyeYesnoValue;
	...
	public TijianxiangmuyuyyeView() {

	}

	public TijianxiangmuyuyyeView(TijianxiangmuyuyyeEntity tijianxiangmuyuyyeEntity) {
		try {
			BeanUtils.copyProperties(this, tijianxiangmuyuyyeEntity);
			...
			* 获取： 审核状态的值
			*/
			public String getTijianxiangmuyuyyeYesnoValue() {
				return tijianxiangmuyuyyeYesnoValue;
			}
			/**
			* 设置： 审核状态的值
			*/
			public void setTijianxiangmuyuyyeYesnoValue(String tijianxiangmuyuyyeYesnoValue) {
				this.tijianxiangmuyuyyeYesnoValue = tijianxiangmuyuyyeYesnoValue;
			}
