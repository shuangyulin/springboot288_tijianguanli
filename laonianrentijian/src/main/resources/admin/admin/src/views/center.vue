  ...
  <div>
    ...
    >  
     <el-row>
         ...
         <el-col :span="12">
           <el-form-item v-if="flag=='yonghu'"  label='出生日期' prop="yonghuChushengriqi">
               <el-input v-model="ruleForm.yonghuChushengriqi"  placeholder='出生日期' clearable></el-input>
           </el-form-item>
         </el-col>
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
                         ...
                         if((!this.ruleForm.yonghuChushengriqi)&& 'yonghu'==this.flag){
