...
var indexNav = [
    ...
    {
        name: '健康常识',
        url: './pages/jiangkangchangshi/list.html'
    },
    {
        name: '疾病预防',
        url: './pages/jibingyufang/list.html'
    },
    {
        name: '网站介绍',
...
var adminurl =  "http://localhost:8080/laonianrentijian/admin/dist/index.html#/login";
